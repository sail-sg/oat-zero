...
def main(
    ...
    stats = {
        ...
        "precision": round((pass_ls * reflection_ls).sum() / reflection_ls.sum(), 3),
        "recall": round((pass_ls * reflection_ls).sum() / pass_ls.sum(), 3),
        "correct_format_eos_rate": round(count_correct_format_n_eos / (len(output) * n_samples), 3)
    }
